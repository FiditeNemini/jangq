...
| `DSV4_POOL_QUANT` | `1` | Native q8 compression for DSV4 CSA/HCA pooled state. Set `0` to opt out for a diagnostic comparison; generic TurboQuant KV remains disabled for this composite cache. |
