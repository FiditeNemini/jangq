...
- [ ] **M85** — `allocate.py` has inconsistent "512+" vs "256+" language in 6+ places (lines 62, 77, 81, 87, 94, 246, 303, 520). The code is correct post-M83 fix but the prose still misleads future auditors. Sweep comments.
