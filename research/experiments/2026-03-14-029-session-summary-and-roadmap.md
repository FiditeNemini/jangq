# Session Summary: JANG Core Thesis Proven
...
- JANG file format spec (FORMAT.md) — open standard
...
2. Missing non-quantized tensors (norms, biases) in .jang output
...
1. **8-bit JANG matches bf16 reference** — logit 15.38 = 15.38
...
6. 0.5B model too small for <8-bit — JANG targets 7B+
...
```
Layer Type    | % of Params | Sensitivity | JANG Bits | Uniform Bits
-------------|-------------|-------------|----------|-------------
...
5. **Publish first JANG models** — dealignai HuggingFace

### What This Means for the Paper

Claim: "JANG at 3.4-bit average produces output quality equal to or
better than uniform 4-bit quantization, enabling 20% memory savings
with no quality loss."

Evidence:
- Experiment 028: MSE 11.10 (JANG 3.37-bit) < 11.31 (uniform 4-bit)
- Proven using MLX's own quantizer (no JANG-specific artifacts)
...
ee47cd3 VERIFIED: JANG forward pass produces correct inference at 8-bit
...
