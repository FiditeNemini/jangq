# Experiment 030: JANG-3 Profile on Qwen2.5-3B
...
- Profile: jang-3 (MLP=3bit, attention=6bit, embed=4bit, lm_head=6bit)
- Model: Qwen2.5-3B
- Quantization: RTN (no AWQ, no GPTQ)

## Results

| Metric | JANG-3 Profile | JANG 8-bit | MLX Uniform 4-bit |
|--------|---------------|-----------|-------------------|
