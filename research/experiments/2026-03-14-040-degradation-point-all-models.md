# Experiment 040: Degradation Points — Where JANG Beats Uniform
...
### MQ3L (3.6b) vs Uniform 3-bit (3.5b) — JANG WINS ON 2 PROMPTS
...
### MQ2S (2.5b) vs Uniform 2-bit (2.5b) — SAME BITS, 4 JANG WINS

Both fail, but JANG produces English fragments while uniform produces garbage.

---

## Mistral-7B-v0.3 — BIGGEST WINS

### MQ4S (4.1b) vs Uniform 4-bit (4.5b) — JANG WINS, 9% SMALLER
...
### MQ2S (2.5b) vs Uniform 2-bit (2.5b) — SAME SIZE, JANG GIVES REAL ANSWERS
...
The value of JANG for very large models is at the 2-2.5 bit level
...
| Model | Uniform Breaks At | JANG Holds Until | Best Win |
|-------|-------------------|-------------------|----------|
...
JANG MQ4S:     "The answer is 4. But what if the question was 2+2=?..."
```
...
JANG MQ2S:     "1. Jupiter 2. Mars 3. Saturn"
```
...
JANG MQ3L:     "Sure, here are three planets in our solar system: 1. Earth 2. Mars 3..."
```
