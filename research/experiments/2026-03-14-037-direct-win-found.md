# Experiment 037: DIRECT WIN — JANG Beats Uniform at Near-Same Bits
...
| **JANG MLP=4/A=5** | **4.12** | **"A tomato is a fruit. It is botanically classified..."** | **Correct** ✓ |
| **JANG MLP=4/A=8** | **4.49** | **"A tomato is a fruit. It is botanically classified..."** | **Correct** ✓ |
...
- **JANG MLP=4/attn=5 SUCCEEDS** — gives the correct factual answer

The difference: JANG gives the attention layers 5 bits instead of 4.
...
- JANG MLP=4/A=8: "x + 3 - 3 = 7 - 3, x = 4" ✓ (shows math steps)

### "Write a haiku about the moon."
- Uniform 4-bit: "ancient sky, lunar glow, ancient sky, lunar glow..." ✗ repetition
- JANG MLP=4/A=8: "The moon's glow, a tranquil sight..." ✓ actual poem
...
JANG's higher attention precision prevents this by maintaining
...
- JANG gives correct answers where uniform gives repetition garbage
- Uses MLX's own quantizer (no JANG implementation artifacts)

For the paper:
"JANG at 4.12 effective bits produces correct, factual answers on
